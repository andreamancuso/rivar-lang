...
It is being [built from scratch in OCaml](https://dev.realworldocaml.org/parsing-with-ocamllex-and-menhir.html) (with the help of LLMs), designed to bring native **Design by Contract (DbC)** to the modern developer's toolbox.
